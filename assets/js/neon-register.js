			...
			submitHandler: function(ev)
			{
				...
				{//alert("2");
					...
					{//alert("3");
                        ...
                        var dataObject,
                            a1 = $("input#username").val(),
                            a2 = $("input#password").val(),
                            a3 = $("input#email").val(),
                            a4 =  $("input#nr_matricol").val(),
                            a5 =		$("input#name").val(),
                            a6 =		$("input#phone").val(),
                            a7 = 	$("select#faculty").val(),
                            a8 = 	    $("input[name=year]:checked").val(),
                            a9 =      $("input#group").val(),
                            a10 = $("input[name=tipUser]:checked").val();
