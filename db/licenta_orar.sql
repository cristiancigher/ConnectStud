...
CREATE TABLE `orar` (
  ...
  PRIMARY KEY (`id_orar`),
  KEY `id_curs_idx` (`id_curs`),
  KEY `id_grupa_idx` (`id_grupa`),
  CONSTRAINT `id_curs` FOREIGN KEY (`id_curs`) REFERENCES `cursuri` (`id_curs`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `orar` VALUES (1,1,1,'10:00','12:00',30131,1,2),(2,1,1,'10:00','12:00',30131,1,2),(3,0,0,'10:00','12:00',30131,1,2),(4,1,0,'12:00','14:00',30131,2,6);
